...
class Program
{
    ...
    static void MenuRelatorio()
    {
        ...
        do
        {
            ...
            Console.WriteLine($"{Produto2} - Quantidade = {Produto2Vendas} - Valor Vendido {Produto2Vendido:F2}");
            Console.WriteLine($"{Produto3} - Quantidade = {Produto3Vendas} - Valor Vendido {Produto3Vendido:F2}");
