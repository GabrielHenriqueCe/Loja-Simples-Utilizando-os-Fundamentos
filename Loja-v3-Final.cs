...
class Program
{
    ...
    static void MenuRelatorio()
    {
        ...
        do
        {
            ...
            Console.WriteLine($"{Produto1} - Quantidade = {Produto1Vendas} - Valor Vendido {Produto1Vendido:F2}");
            Console.WriteLine($"{Produto1} - Quantidade = {Produto2Vendas} - Valor Vendido {Produto2Vendido:F2}");
            Console.WriteLine($"{Produto1} - Quantidade = {Produto3Vendas} - Valor Vendido {Produto3Vendido:F2}");
            Console.WriteLine($"Valor Total Vendido = {(Produto1Vendido + Produto2Vendido + Produto3Vendido)}");
    ...
    static void MenuEstoque()
    {
        ...
        "Voltar"
            ...
            Console.WriteLine("\nDeseja repor ou retirar algum produto?");
            ...
            if (entradaEstoque != 4) //Se a entrada for diferente de 4 define produto atual
            {
                ...
                //Entrada de quantidade de produtos escolhidos
                int reporQuantidade = entradaValida("Quantos você quer adicionar ao estoque? \nSe deseja retirar do estoque digite o número Negativo!", -quantidadeMaxima, 100, "de Estoque", opcoesEstoque);
